...
| Variable | Used in | Purpose |
|---|---|---|
| `SUPABASE_URL` | `src/lib/admin-content/storage/index.ts` | Server-side Supabase project URL for admin upload storage |
...
| `EDUNANCIAL_UPLOAD_STORAGE_KEY` / `EDUNANCIAL_UPLOAD_STORAGE_BUCKET` | `src/lib/admin-content/storage/index.ts` | Supabase storage bucket for admin uploads and exports |
