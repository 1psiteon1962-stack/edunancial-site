...
- Confirm no new CSP/redirect regressions from `_headers` and `_redirects`.

## Communication
- Record rollback timestamp and deploy IDs (failed and restored).
- Post incident update with impact summary and next corrective actions.
