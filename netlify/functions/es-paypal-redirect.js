exports.handler = async (event) => {
  ...
  const itemName = params.item_name || "Curso Mini: Método Edunancial";
  ...
  const returnUrl = "https://www.edunancial.com/es/gracias";
  const cancelUrl = "https://www.edunancial.com/es/cancelado";
