...
const TRACK_COLORS: Record<string, { badge: string; heading: string; button: string }> = {
  RED: { badge: "text-red-400 border-red-500/40 bg-red-500/10", heading: "text-red-400", button: "bg-red-700 hover:bg-red-600" }, WHITE: { badge: "text-slate-300 border-slate-500/40 bg-slate-500/10", heading: "text-slate-300", button: "bg-slate-700 hover:bg-slate-600" }, BLUE: { badge: "text-blue-400 border-blue-500/40 bg-blue-500/10", heading: "text-blue-400", button: "bg-blue-700 hover:bg-blue-600" }, GREEN: { badge: "text-green-400 border-green-500/40 bg-green-500/10", heading: "text-green-400", button: "bg-green-700 hover:bg-green-600" }, GOLD: { badge: "text-yellow-400 border-yellow-500/40 bg-yellow-500/10", heading: "text-yellow-400", button: "bg-yellow-600 hover:bg-yellow-500" }, PURPLE: { badge: "text-purple-400 border-purple-500/40 bg-purple-500/10", heading: "text-purple-400", button: "bg-purple-700 hover:bg-purple-600" }, ORANGE: { badge: "text-orange-400 border-orange-500/40 bg-orange-500/10", heading: "text-orange-400", button: "bg-orange-700 hover:bg-orange-600" }, BLACK: { badge: "text-slate-200 border-slate-400/40 bg-slate-400/10", heading: "text-slate-200", button: "bg-slate-800 hover:bg-slate-700" },
};
