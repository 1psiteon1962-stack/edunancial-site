    ...
    <main className="min-h-screen bg-[#08101f] text-white">
      <section className="mx-auto max-w-5xl px-6 py-20">
        ...
        <p className="mt-6 max-w-3xl text-xl leading-9 text-slate-300">
          This core deck is included with Edunancial membership. No Marketplace purchase is required.
        </p>
        <div className="mt-12 rounded-2xl border border-white/10 bg-slate-900 p-8">
          <h2 className="text-2xl font-black">Deck ready for content</h2>
          <p className="mt-3 leading-7 text-slate-400">
            The Practice route is active. Flashcard content for this track will appear here as the prepared card packages are uploaded and published.
          </p>
        </div>
      </section>
    </main>
