  ...
  return (
    <main className="min-h-screen bg-[#08101f] text-white">
      <section className="mx-auto max-w-7xl px-6 py-20">
        ...
        <p className="mt-6 max-w-4xl text-xl leading-9 text-slate-300">Core Edunancial flashcards are included with your membership. There is no additional charge and no Marketplace purchase is required.</p>
        <p className="mt-3 max-w-4xl text-slate-400">Choose a curriculum track to reinforce key concepts. Skills Labs, scenarios, calculators and assessments also belong in Practice as they are released.</p>
