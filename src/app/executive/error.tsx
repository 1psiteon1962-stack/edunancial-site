...
export default function ExecutiveError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error("[Executive] PRODUCTION RUNTIME ERROR", {
  ...
  return (
    <main className="min-h-screen bg-[#08101f] px-6 py-16 text-white">
      <div className="mx-auto max-w-2xl rounded-2xl border border-red-500/40 bg-red-950/30 p-8">
        ...
        <button
          onClick={reset}
          className="mt-8 rounded-xl bg-yellow-500 px-5 py-3 font-bold text-slate-900 hover:bg-yellow-400"
        >
          Try again
        </button>
      </div>
