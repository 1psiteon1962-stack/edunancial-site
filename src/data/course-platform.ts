...
export const lessons: Record<string, Lesson> = {
  ...
  "red-01": {
    ...
    description: "Define real estate as an asset class, understand how ownership generates wealth through cash flow and appreciation, and learn the key categories of real estate investment.",
    notes: "Real estate is one of the oldest and most reliable wealth-building vehicles. In this lesson we define real estate as a distinct asset class, examine how ownership creates wealth through cash flow and appreciation, and introduce the key investment categories: residential, commercial, industrial, raw land, and REITs.",
    order: 1,
