...
export const instructors: Record<string, Instructor> = {
  ...
  "red-instructor": {
    ...
    courses: ["red-level-1", "red-real-estate"],
    students: 5800,
    rating: 4.8,
  },
  "white-instructor": {
...
export const lessons: Record<string, Lesson> = {
  ...
  "red-101": {
    id: "red-101",
    courseId: "red-level-1",
    title: "Introduction to Real Estate Investing",
    duration: "18 min",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    description: "Understand why real estate builds wealth through the four pillars: cash flow, appreciation, tax benefits, and equity. Shift your mindset from homeowner to investor.",
    notes: "Real estate is one of the oldest and most reliable wealth-building vehicles. The four pillars—cash flow, appreciation, tax benefits, and equity build-up—work simultaneously when you invest correctly. Start with one property and think like a business owner, not a homeowner.",
    order: 1,
    downloadUrl: "/downloads/red-101-notes.pdf",
  },
  "red-102": {
    id: "red-102",
    courseId: "red-level-1",
    ...
    duration: "24 min",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    description: "Master the 1% rule, NOI calculation, and cash-on-cash return to evaluate any rental property quickly and accurately.",
    notes: "Cash flow is king. NOI = Gross Rent − Vacancy − Operating Expenses. Cash-on-Cash Return = Annual Cash Flow / Total Cash Invested × 100. Always budget for vacancy, CapEx, repairs, and management before claiming a property cash flows.",
    order: 2,
    downloadUrl: "/downloads/red-102-cashflow.pdf",
  },
  "red-103": {
    id: "red-103",
    courseId: "red-level-1",
    ...
    duration: "20 min",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    description: "Read market cycles, analyze local vacancy rates and price trends, and know when conditions favor buying, holding, or selling.",
    notes: "Real estate markets move through four phases: recovery, expansion, hyper-supply, and recession. Use vacancy rates, days-on-market, population trends, and the price-to-rent ratio to evaluate any local market. National headlines rarely reflect your target market.",
    order: 3,
  },
  "red-104": {
    id: "red-104",
    ...
    duration: "22 min",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    description: "Compare conventional loans, portfolio loans, hard money, and FHA house hacking. Calculate leverage and DSCR to evaluate financing options.",
    notes: "DSCR = NOI / Annual Debt Service. Lenders typically require 1.25+. With 20% down on a $200,000 property, a 5% appreciation yields a 25% cash return on your invested capital—the power of leverage. Never over-leverage; leave a margin of safety.",
    order: 4,
    downloadUrl: "/downloads/red-104-financing.pdf",
  },
  "red-105": {
    id: "red-105",
    courseId: "red-level-1",
    ...
    duration: "25 min",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    description: "Use the MLS, direct mail, wholesalers, and auctions to find deals. Apply the 70% rule and a due diligence checklist before every offer.",
    notes: "MAO = (ARV × 70%) − Estimated Repairs. Run a full due diligence checklist: title search, inspection, zoning, flood zone, rent comps, and neighborhood walk. Set your max bid before you enter the auction room—never let auction fever drive your offer.",
    order: 5,
    downloadUrl: "/downloads/red-105-due-diligence.pdf",
  },
  "red-106": {
    id: "red-106",
    courseId: "red-level-1",
    ...
    duration: "20 min",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    description: "Earn 8–36% annual returns by investing in government tax lien certificates. Learn the auction process, redemption periods, and risk management.",
    notes: "Tax lien certificates are created when property owners fail to pay taxes. The county sells the debt to investors. Statutory interest rates range from 8–36% depending on the state. In practice, 95–98% of liens are redeemed—investors collect interest. The remaining 1–5% progress to foreclosure, potentially yielding the property itself.",
    order: 6,
  },
  "red-107": {
    id: "red-107",
    ...
    duration: "22 min",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    description: "Buy real property directly from the county at tax deed auctions. Understand the deed, quiet title process, and risk management.",
    notes: "Tax deed auctions transfer property ownership from the county to the highest bidder, starting at back taxes owed. Unlike tax liens, you receive the property itself. Due diligence is critical: check for senior liens, estimate repairs assuming worst-case interior condition, and budget for a quiet title action to clear the title before selling.",
    order: 7,
    downloadUrl: "/downloads/red-107-taxdeed.pdf",
  },
  "red-108": {
    id: "red-108",
    courseId: "red-level-1",
    ...
    duration: "28 min",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    description: "Acquire properties with little or no bank financing using seller financing, subject-to, lease options, and wraparound mortgages.",
    notes: "Creative financing tools: (1) Seller financing—seller acts as the bank; (2) Subject-to—you take the deed while seller's loan stays in place; (3) Lease option—control a property with minimal capital; (4) Wraparound mortgage—seller creates a new mortgage over an existing one. All require proper legal documentation and full disclosure.",
    order: 8,
  },
  "red-109": {
    id: "red-109",
    ...
    duration: "26 min",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    description: "Screen tenants properly, draft airtight leases, handle security deposits legally, and manage the eviction process correctly.",
    notes: "Tenant screening criteria: income ≥ 3× rent, 620+ FICO, no prior evictions. Apply criteria consistently to all applicants (Fair Housing compliance). Security deposit law is state-specific—know your state's return deadline and itemization requirements. Self-help evictions are illegal everywhere.",
    order: 9,
    downloadUrl: "/downloads/red-109-tenant-screening.pdf",
  },
  "red-110": {
    id: "red-110",
    courseId: "red-level-1",
    ...
    duration: "30 min",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    description: "Deploy the BRRRR strategy to recycle capital and scale your portfolio. Build the right legal structure and investor team for long-term wealth.",
    notes: "BRRRR = Buy, Rehab, Rent, Refinance, Repeat. Goal: return all invested capital via cash-out refinance while retaining the property and its cash flow—infinite return. Protect growing equity with an LLC structure. Build your team: attorney, CPA, lender, property manager, contractor, and insurance agent.",
    order: 10,
    downloadUrl: "/downloads/red-110-portfolio.pdf",
  },
  // WHITE — Paper Assets
  "white-01": {
    id: "white-01",
...
export const courses: Record<string, Course> = {
  "red-level-1": {
    id: "red-level-1",
    title: "RED 101–110: Real Estate Foundations",
    subtitle: "The complete foundation for real estate investing — cash flow, markets, financing, tax liens, tax deeds, and creative strategies.",
    description: "RED Level 1 is the authoritative starting point for every serious real estate investor. Across 10 structured lessons you will master cash flow analysis, market evaluation, investment property financing, deal finding, tax lien and tax deed investing, creative financing strategies, property management, and portfolio building using the BRRRR method. Every lesson is built on real-world application.",
    category: "Real Estate",
    difficulty: "Beginner",
    instructor: "red-instructor",
    lessons: ["red-101", "red-102", "red-103", "red-104", "red-105", "red-106", "red-107", "red-108", "red-109", "red-110"],
    quizzes: ["quiz-real-estate-intro"],
    totalDuration: "3h 35min",
    enrolledCount: 0,
    rating: 4.9,
    reviewCount: 0,
    thumbnail: "/images/course-red.jpg",
    color: "bg-red-700",
    tags: ["Real Estate", "Passive Income", "Tax Liens", "Tax Deeds", "Cash Flow", "BRRRR", "Creative Financing"],
    certificateId: "cert-red-level-1",
    isFeatured: true,
  },
  "red-real-estate": {
    id: "red-real-estate",
