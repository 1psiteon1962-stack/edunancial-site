...
export const lessons: Record<string, Lesson> = {
  ...
  "red-06": {
    ...
    order: 6,
    downloadUrl: "/downloads/red-06-1031.pdf",
  },
  "red-07": {
    id: "red-07",
    courseId: "red-real-estate",
    ...
    duration: "21 min",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    description: "How to inspect, research, and verify every aspect of a property before committing to a purchase.",
    notes: "Due diligence is your protection against costly surprises. Verify title, inspect the property, review zoning, confirm utilities, and analyze neighborhood trends before closing any deal. Never skip a title search.",
    order: 7,
    downloadUrl: "/downloads/red-07-due-diligence.pdf",
  },
  "red-08": {
    id: "red-08",
    courseId: "red-real-estate",
    ...
    duration: "19 min",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    description: "Tenant screening, lease agreements, maintenance systems, and scaling from one unit to a portfolio.",
    notes: "Effective property management determines whether rental real estate is truly passive income or a second job. Systems for tenant screening, rent collection, maintenance tracking, and vacancy management are essential for scalability.",
    order: 8,
    downloadUrl: "/downloads/red-08-property-mgmt.pdf",
  },
  "red-09": {
    id: "red-09",
    courseId: "red-real-estate",
    title: "Real Estate Financing & Leverage",
    duration: "25 min",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    description: "Conventional loans, hard money, private money, and using leverage to multiply your real estate returns.",
    notes: "Leverage is the most powerful tool in real estate — it lets you control an asset worth far more than the cash you put in. Understand debt-service coverage ratio (DSCR), loan-to-value (LTV), and how to use each financing type strategically.",
    order: 9,
    downloadUrl: "/downloads/red-09-financing.pdf",
  },
  "red-10": {
    id: "red-10",
    courseId: "red-real-estate",
    ...
    duration: "26 min",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    description: "Portfolio strategy, scaling from 1 to 10 units, entity structuring, and creating lasting passive income.",
    notes: "Building a real estate portfolio requires a deliberate strategy: choose your primary investing vehicle, establish your entity structure (LLC is standard), build reserves, and reinvest cash flow systematically. The BRRRR method — Buy, Rehab, Rent, Refinance, Repeat — is the most efficient scaling framework for residential investors.",
    order: 10,
    quizId: "quiz-real-estate-intro",
    downloadUrl: "/downloads/red-10-portfolio.pdf",
  },
  // WHITE — Paper Assets
  "white-01": {
    id: "white-01",
...
export const courses: Record<string, Course> = {
  "red-real-estate": {
    ...
    lessons: ["red-01", "red-02", "red-03", "red-04", "red-05", "red-06", "red-07", "red-08", "red-09", "red-10"],
