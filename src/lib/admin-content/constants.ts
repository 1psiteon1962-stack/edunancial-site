...
export const COLOR_TRACK_SUBJECTS: Record<CourseTrack, string> = { red: "Real Estate", white: "Paper Assets", blue: "Business", green: "Taxes", gold: "Investing & Wealth Building", purple: "Law", orange: "Sales & Marketing", black: "Leadership & Executive" };
