...
export const COLOR_TRACK_SUBJECTS: Record<CourseTrack, string> = {
  red: "Real Estate", white: "Paper Assets", blue: "Business", green: "Taxes", gold: "Investing & Wealth Building", purple: "Law", orange: "Sales & Marketing", black: "Leadership & Executive",
};
...
/** Base aliases remain for backward compatibility; regional variants stay distinct. */
export const SUPPORTED_UPLOAD_LANGUAGES = [
  "en", "en-US", "en-GB", "es", "es-Caribbean", "es-ES", "fr", "fr-CA", "fr-FR",
  "pt", "pt-BR", "pt-PT", "de", "it", "nl",
] as const;
