...
export function createDirectUploadSpec(
  ...
  // Remove trailing slashes so that the URL never contains double-slash
  // segments (e.g. https://xxx.supabase.co//storage/…) which the Supabase
  // CDN returns a 404 HTML page for.
