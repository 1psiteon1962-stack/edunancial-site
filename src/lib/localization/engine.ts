...
const CONTENT_LAYERS: ContentLayers = {
  ...
  regionalOverrides: {
    ...
    caribbean: {
      ...
      legalNotices: {
        ...GLOBAL_LEGAL_NOTICES,
        privacy: "Caribbean privacy notice. This platform complies with applicable privacy regulations across Caribbean jurisdictions.",
        terms: "Caribbean terms and disclosures. Content is provided for educational purposes only.",
        cookies: "Caribbean cookie notice.",
        refunds: "Caribbean refund policy placeholder.",
        consumerRights: "Caribbean consumer rights placeholder.",
        educationalDisclaimer: "Caribbean educational disclaimer.",
        taxDisclaimer: "Caribbean tax disclaimer.",
        investmentDisclaimer: "Caribbean investment disclaimer.",
      },
      taxDisclaimers: [
        "Pricing is displayed in USD. Local taxes and duties may apply depending on your jurisdiction.",
      ],
      consumerDisclosures: [
        "Edunancial Caribbean provides financial education only and does not constitute financial advice.",
      ],
