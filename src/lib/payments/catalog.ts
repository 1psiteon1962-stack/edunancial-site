...
export const paymentCatalog: PaymentCatalogItem[] = [
  ...
  },
  {
    ...
    description: "Full-year Basic membership with approximately two months of savings versus monthly billing.",
  ...
  {
    id: "membership-premium-annual",
    name: "Pro Membership — Annual",
    description: "Full-year Pro membership with approximately two months of savings versus monthly billing.",
    type: "membership_annual",
    price: 699.99,
    currency: "USD",
    isRecurring: true,
  ...
  {
    id: "membership-enterprise-annual",
    name: "Gold Membership — Annual",
    description: "Full-year Gold membership with approximately two months of savings versus monthly billing.",
    type: "membership_annual",
    price: 999.99,
    currency: "USD",
    isRecurring: true,
